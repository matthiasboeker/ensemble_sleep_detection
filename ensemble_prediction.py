...
from algorithms.traditional_algorithms import calculate_cole_kripke_30sec, sadeh_sleep_stage_algo, fourier_based_hmm, sazonova_algorithm, calculate_oakley
...
def main():
    ...
    algorithms = {"CK": calculate_cole_kripke_30sec, "Sadeh": sadeh_sleep_stage_algo, "HMM": fourier_based_hmm,

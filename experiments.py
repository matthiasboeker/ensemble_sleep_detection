...
def train(model, optimizer, criterion, X_train, Y_train, X_test, Y_test, epochs, batch_size, patience, min_delta):
...
def run_training(X_train, X_test, Y_train, Y_test, classifier_name, classifier, criterion, optimizer, epochs, batch_size, patience=20, min_delta=0.001):
    if classifier_name == "LSTM":
        X_train = X_train.unsqueeze(2)
        X_test = X_test.unsqueeze(2)
    train(classifier, optimizer, criterion, X_train, Y_train, X_test, Y_test, epochs, batch_size, patience=20, min_delta=0.001)
        ...
        for experiment_name, experiment in experiments.items():
            ...
            for type_name, type in experiment.items():
                ...
                for name, model in models.items():
                    ...
                    run_training(X_train, X_test, type["train"], type["test"], name, model, criterion, optimizer, epochs=200, batch_size=512, patience=20, min_delta=0.001)
